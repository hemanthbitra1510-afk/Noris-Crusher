...
const SalesRegDebitors = () => {
  ...
  const headers = [
    ...
    { label: "Payable", key: "Credit", dataType: "number" },
  ...
  const fetchData = async () => {
    try {
      ...
      const response = await axios.get<DebitorEntry[]>(
        `https://norisapi.noris.in/Crusher/Sales.php?ID=${id}&TableName=SalesDebitors`
      );
    ...
    <div className="page-wrapper">
      <div className="content p-2">
        ...
        {loading ? (
          ...
          <ProductionList title="Debitor Balance Report"
